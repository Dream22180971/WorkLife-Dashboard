...
按 **WorkLife PRD v1.2** 迭代，当前 v0.1 已覆盖核心闭环：
...
完整需求见 [`WorkLife_PRD_v1.2.md`](./WorkLife_PRD_v1.2.md)，高保真原型见 [`WorkLife_Prototype_v1.2.html`](./WorkLife_Prototype_v1.2.html)（浏览器直接打开）。
